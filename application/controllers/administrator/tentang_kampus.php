...
class Tentang_kampus extends CI_Controller{
	...
	{
		$data['tentang_kampus']  = $this->tentang_model->tampil_data('tentang_kampus')->result();
	...
	{
              $where = array('id' => $id);
              $data['tentang_kampus']  = $this->tentang_model->edit_data($where,
              	'tentang_kampus')->result();
               $this->load->view('templates_administrator/header');
		       $this->load->view('templates_administrator/sidebar');
	...
	public function update_aksi()
	{
		...
		$this->tentang_model->update_data($where,$data,'tentang_kampus');
		 $this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
               Data TENTANG KAMPUS Berhasil Di Update !!! 
