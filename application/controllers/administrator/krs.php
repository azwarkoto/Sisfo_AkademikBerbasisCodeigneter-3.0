...
class Krs extends CI_Controller{
	...
	public function krs_aksi()
	{
	 ...
	 { 
		...
		$data = array(
			...
			'nama_lengkap' => $this->mahasiswa_model->
			get_by_id($nim)->nama_lengkap
		...
		$dataKrs = array(
			...
			'nim'      => $nim,
			'id_thn_akad' => $id_thn_akad,
			'tahun_akademik' => $this->tahunakademik_model->get_by_id($id_thn_akad)
			->tahun_akademik,
			'semester' => $this->tahunakademik_model->get_by_id($id_thn_akad)
			->semester==1?'Ganjil':'Genap',
			'nama_lengkap' => $this->mahasiswa_model->get_by_id($nim)
			->nama_lengkap,
	...
	public function baca_krs($nim,$thn_akad)
	{
		...
		$this->db->join('matakuliah as m', 'm.kode_matakuliah = 
			  k.kode_matakuliah');
...

	{
		$data = array(
			...
			'thn_akad_smt' => $this->tahunakademik_model->
			get_by_id($thn_akad)->tahun_akademik,
			'semester' => $this->tahunakademik_model->get_by_id($thn_akad)
			->semester==1?'Ganjil':'Genap',
			'nim'              => $nim,
